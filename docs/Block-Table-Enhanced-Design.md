...
{{renderer :blockview table, theme=notion, colWidths={"marker":60,"content":300,"page":120,"createdAt":150,"updatedAt":150}}}
```
...
| `colWidths` | string | 列宽 JSON 对象 | 默认列宽 |
...
│  │  │ 标记  │ 内容                        │ 页面       │ 创建时间       │ 更新时间      │ │ │
│  │  │ ───── ┼ ─────────────────────────── ┼ ────────── ┼ ────────────── ┼ ───────────── │ │ │
│  │  │ ✓     │ 完成项目计划文档             │ 工作记录   │ 2026-05-11     │ 2026-05-12    │ │ │
│  │  │ ○     │ 设计 UI 界面原型             │ 工作记录   │ 2026-05-12     │ 2026-05-13    │ │ │
│  │  │ ●     │ 实现核心功能模块             │ 工作记录   │ 2026-05-13     │ 2026-05-14    │ │ │
│  │  │ ◐     │ 编写测试用例                 │ 工作记录   │ 2026-05-14     │ 2026-05-14    │ │ │
│  │  │ ○     │ 部署到生产环境               │ 工作记录   │ 2026-05-14     │ 2026-05-14    │ │ │
│  │  └───────────────────────────────────────────────────────────────────────────────────┘ │ │
│  │                              ║                                 ║                       │ │
│  │  ──────────────────────────────║──────────────────────────────────║───────────────────   │ │
│  │                              ║      Column  Resizing             ║                       │ │
