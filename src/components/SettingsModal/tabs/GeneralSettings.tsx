...
function GeneralSettings({ settings, setSettings, onSave, isSaving, language }: TabComponentProps) {
  ...
  return (
    <div className="ltt-settings-tab-content">
      ...
      <div className="ltt-setting-item">
        <label>{t('settings.taskProgressLabel', language)}</label>
        <label className="ltt-switch">
          <input
            type="checkbox"
      ...
      <div className="ltt-setting-item">
        <label>{t('settings.heatmapLabel', language)}</label>
        <label className="ltt-switch">
          <input
            type="checkbox"
      ...
      <div className="ltt-setting-item">
        <label>{t('settings.blockViewLabel', language)}</label>
        <label className="ltt-switch">
          <input
            type="checkbox"
      ...
      <div className="ltt-setting-item">
        <label>{t('settings.summaryLabel', language)}</label>
        <label className="ltt-switch">
          <input
            type="checkbox"
      ...
      <div className="ltt-setting-item">
        <label>{t('settings.milestoneLabel', language)}</label>
        <label className="ltt-switch">
          <input
            type="checkbox"
