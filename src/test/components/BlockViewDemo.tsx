                    ...
                    <div class="block-children-container flex">
                        ...
                        <div class="block-children w-full">
                            <div data-level="2" class="blocks-list-wrap">
                                ...
                                <div haschild="true" class="ls-block swipe-item " level="1"
                                    blockid="6a03fa5c-0261-4ced-b6bd-3a9a4e449ccd" id="ls-block-6a03fa5c-0261-4ced-b6bd-3a9a4e449ccd"
                                    containerid="1">
                                    <div class="block-main-container flex flex-row gap-1">
                                        <div class="block-control-wrap flex flex-row items-center h-6"><a
                                                id="control-6a03fa5c-0261-4ced-b6bd-3a9a4e449ccd" class="block-control"><span
                                                    class="control-hide"><span class="rotating-arrow not-collapsed"><svg
                                                            aria-hidden="true" version="1.1" viewBox="0 0 192 512"
                                                            fill="currentColor" display="inline-block" class="h-4 w-4"
                                                            style="margin-left: 2px;">
                                                            <path
                                                                d="M0 384.662V127.338c0-17.818 21.543-26.741 34.142-14.142l128.662 128.662c7.81 7.81 7.81 20.474 0 28.284L34.142 398.804C21.543 411.404 0 402.48 0 384.662z"
                                                                fill-rule="evenodd"></path>
                                ...
                                <div haschild="true" class="ls-block swipe-item " level="1"
                                    ...
                                    <div class="block-main-container flex flex-row gap-1">
                                        <div class="block-control-wrap flex flex-row items-center h-6"><a
                                                ...
                                                data-state="closed"><span id="dot-6a03f998-9353-4483-aaf3-3586a42ac4da"
